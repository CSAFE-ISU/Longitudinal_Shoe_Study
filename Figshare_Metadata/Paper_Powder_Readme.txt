DATA TITLE: Longitudinal Shoe Study: Paper + Powder images
...
== Overview ==
Scans of shoe prints obtained following the CSAFE Paper and Powder collection procedure.
...
- FilmScanImages.zip
Contains the scans of the shoe prints taken with the Paper and Powder print methodology. Images are named with respect to the following convention:
...
Prints and measurements for this data set were taken using the following equipment: Paper and Powder. This method is documented in the CSAFE Longitudinal Shoe Study Collection Procedures Collection (DOI: http://doi.org/10.25380/iastate.8016341), specifically the following documents:
  - Paper_Vinyl_Prints.pdf
  - Scanning_Film_Paper_Prints.pdf
