...
== Overview ==
Scans of shoe prints obtained following the CSAFE Film and Powder collection procedure.
...
- FilmScanImages.zip
Contains the scans of the shoe prints taken with the Powder and Adhesive Film methodology. Images are named with respect to the following convention:
...
Prints and measurements for this data set were taken using the following equipment: Powder and Adhesive Film. This method is documented in the CSAFE Longitudinal Shoe Study Collection Procedures Collection (DOI: http://doi.org/10.25380/iastate.8016341), specifically the following documents:
  - Film_Powder_Print.pdf
