...
== Overview ==
Scans of shoe prints obtained following the CSAFE 2D Digital Scan collection procedure.
...
Prints and measurements for this data set were taken using the following equipment: Everspry EverOS 2D Digital Scanner. This method is documented in the CSAFE Longitudinal Shoe Study Collection Procedures Collection (DOI: http://doi.org/10.25380/iastate.8016341), specifically the following documents:
  - 2D_Digital_Scanner_Everos.pdf
